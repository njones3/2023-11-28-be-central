...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		System.out.println("There are " + numberOfCookies + " cookies.");
		System.out.println("There are " + numberOfChildren + " children.");
		System.out.println("The remaining cookies are " + remainingCookies);
		...
		double adjustedBillTotal = adjustedTotal;
		
		System.out.println("The adjusted bill total is: " + adjustedBillTotal);
